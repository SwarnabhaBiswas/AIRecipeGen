    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {totalCount > 0 && (
          <div className="flex flex-wrap gap-3 mb-6">
            <button
              ...
              className="flex items-center gap-2 bg-primary-500 hover:bg-primary-600 text-white px-4 py-2.5 rounded-lg font-medium transition-colors"
            >
        ...
        {totalCount > 0 ? (
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
            ...
            <button
              onClick={() => setShowAddModal(true)}
              className="inline-flex items-center gap-2 bg-primary-500 hover:bg-primary-600 text-white px-6 py-2.5 rounded-lg font-medium transition-colors"
            >
              <Plus className="w-5 h-5" />
              Add First Item
            </button>
      ...
      {showAddModal && (
        <AddItemModal
          ...
          onSuccess={async () => {
            await fetchShoppingList(); // ✅ fetch fresh data
...
const AddItemModal = ({ onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      onSuccess(); // ✅ no need to pass item
      onClose();
    } catch (error) {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex gap-3 pt-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex-1 px-4 py-2.5 bg-primary-500 hover:bg-primary-600 text-white rounded-lg font-medium transition-colors disabled:opacity-50"
            >
