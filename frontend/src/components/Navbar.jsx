      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-3 relative" ref={dropdownRef}>
            ...
            >
              {/* Avatar */}
              <div className="w-9 h-9 bg-primary-500 text-white flex items-center justify-center rounded-full font-semibold">
                {user?.name?.charAt(0).toUpperCase() || "U"}
              </div>

              {/* Name (optional small screen hidden) */}
            ...
            {/* Dropdown */}
            {isDropdownOpen && (
              <div className="absolute right-0 mt-42 w-64 bg-white rounded-lg shadow-lg border border-gray-200 overflow-hidden z-50">
                {/* User Info */}
                <div className="px-4 py-3 border-b border-gray-200">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-primary-500 text-white flex items-center justify-center rounded-full font-semibold">
                      {user?.name?.charAt(0).toUpperCase() || "U"}
                    </div>
